        ...
        <form id="example-form" action="#" class="mt-5">
          ...
          <div class="row">
            ...
            <div class="col-lg-6  mt-3">
              ...
              <input id="password"  name="password" type="text" class="required password form-control"/>
            </div>
          </div>
          <div class="row">
            <div class="col-lg-6  mt-3">
            ...
            <div class="col-lg-6  mt-3">
              <label for="phone_number_secondary">Secondry Phone *</label>
              <input id="phone_number_secondary" type="text"
                name="phone_number_secondary" class="required 
              form-control"/>
            </div>
          </div>
          <div class="row">
          ...
          <div class="row">
            <div class="col-lg-6  mt-3">
              <button type="button" style="margin-top: 30px; width: 100px; color: #fff;" class="btn btn-success">
                Save</button>
          </div>
          </div>
        </form>
