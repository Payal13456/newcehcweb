      ...
      <form id="example-form" action="#" class="mt-5">
        ...
        <div class="row">
          <div class="col-lg-6  mt-3">
            ...
            name="primary_number"
            type="text"
            class="required primary_number form-control"
            />
          </div>
          <div class="col-lg-6  mt-3">
            ...
            type="text"
            class="required secondary_number form-control"
            />
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-lg-6  mt-3">
            <label for="location">Map Location Link *</label>
              <input id="location" name="location" type="text" class="required location form-control"/>
          </div>
        </div>
      <div class="row">
        <div class="col-lg-6  mt-3">
          ...
          <textarea
          class="form-control" rows="7" cols="5"
          id="address"
          name="address"
          type="text"
          />
