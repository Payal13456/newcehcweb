  ...
  <div class="container-fluid">      
    <div class="card">
      <div class="card-body wizard-content">
        <form id="AddEmployeeForm" method="post" action="{{ route('employee.store') }}" name="AddEmployeeForm" autocomplete="off" enctype="multipart/form-data" onsubmit="submitdata();">          
          <div class="row">
          ...
          <div class="row">
            <div class="col-lg-6 mt-3">
              ...
              <input id="emailAddress" name="emailAddress" type="email" class=" form-control" value="" required=""/>
            ...
            <div class="col-lg-6 mt-3">
              ...
              <input id="phonenumber" name="phonenumber" type="tel" class="form-control " value="" onkeypress="return event.charCode >= 48 && event.charCode <= 57" required>
          ...
          <div class="row">
            <div class="col-lg-6 mt-3">
               ...
               <input id="adharNumber" name="adharNumber" type="text" class="form-control "  onkeypress="return event.charCode >= 48 && event.charCode <= 57" required/>
          ...
          <div class="row">
            <div class="col-lg-6 mt-3">
              ...
              <input id="dob" name="dob" type="date" required class=" form-control" value=""/>
              <span class="text-danger error-text dob_err"></span>
            </div>
            <div class="col-lg-6 mt-3">
              <label for="role">Role *</label>
              <select id="role" name="role" required="" class="select2 form-select shadow-none form-control" style="width: 100%; height: 36px" onchange="checkRole(this.value);">
          ...
          <div class="row">
            ...
            <div class="col-lg-6 mt-3" id="specialization_div" style="display: none;">
            ...
            <div class="col-lg-6 mt-3">
             ...
             <span class="text-danger error-text description_err">
              ...
              <div class="col-lg-6 mt-3">
                ...
                <textarea class="form-control" rows="7" cols="5" id="address" name="address" type="text" required="" /></textarea>
          ...
          <div class="row">
            <div class="col-lg-6 mt-3">
               <label for="customfile">Profile Picture <span style="font-size:10px;">(only Images)</span></label>
